...
AC_AutoExec:
	...
	; a tiny GUI setup
	Gui, 2:Add, Edit, vfrom w300  ,%Hotstring%::
	Gui, 2:Add, Edit, vto  w300 ym0,%Hotstring%
...
CapsLock & a::
	...
	; setting the hotstrings in the edit boxes
	GuiControl,2:, to, %Hotstring%
	GuiControl,2:, from, %Hotstring%::
	
	; focus to the "to" gui
	GuiControl, Focus, to
	Gui, 2:Show
	
	; send control + a in order to selecct the text in the "to" edit box
	Send, ^a
return
