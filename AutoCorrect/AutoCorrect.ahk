...
CapsLock & a::
	...
	AutoTrim Off
	acTempCopy := clipboard
	clipboard :=
	Send ^{c}
	ClipWait 0.1
	Gui, 2:Color, %cBarColor%, %cEditBarColor%
	Gui, 2:+AlwaysOnTop +SysMenu +ToolWindow -caption +border
	Gui, 2:Font, s16, Segoe UI
	Gui, 2:Font, %cTermColor%
	Gui, 2:Add, Edit, -E0x200 x20 y10 w270 h30 vfrom, %Hotstring%::
	Gui, 2:Add, Edit, -E0x200 x310 y10 w270 h30 vto, %Hotstring%

	Gui, 2:Font, %cMidColor%
	Gui, 2:Add, Text, x294 y10 w10 h30, >
	Gui, 2:Add, Button, x-10 y-10 w1 h1 Default gacSubmit
	...
	; focus to the "to" gui
	gui2YPosition := (guiYPosition - 60)
	GuiControl, 2:Focus, to
	Gui, 2:Show, y%gui2YPosition% h50 w600, AutoCorrect
	acState := open

	; send control + a in order to select the text in the "to" edit box
	Send, ^a
return
...
acSubmit:
    ...
    GuiControlGet, from
    Hotstring := "::" from "::" to
    FileAppend, `n%Hotstring%, %A_ScriptDir%\AutoCorrect\AutoCorrect.ahk
...
;-------------------------------------------------------------------------------
; Anything below this point was added to the script by the user via the CapsLock + A hotkey.
;-------------------------------------------------------------------------------
::tomoro::tomorrow
:*:asassin::assassin
